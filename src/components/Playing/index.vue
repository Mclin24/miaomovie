		...
		<Scroller v-else :handleScroll="handleScroll" :handleTouchEnd="handleTouchEnd">
			<ul>
				...
				<li v-for="item in movieList" :key="item.id">
					...
					<div class="info_list">
						<h2 @touchstart="handleToDetail(item.id)">{{item.nm}}<img v-if="item.version" src="@/assets/maxs.png" alt=""/></h2>
...
.movie_body .pullDown{ margin:0; padding:0; border:none;color: lightcoral;text-align: center;}
</style>
